const CACHE='library-reference-navigator-v1';
const ASSETS=['./','./index.html','./css/app.css','./js/prototype-data.js','./js/app.js','./js/search-worker.js','./js/csv-worker.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
